...
import { AdaptiveAvgPooling2DLayerNodeData } from "@/types/Nodes/AdaptiveAvgPooling2DLayerNode.types";
...
const AdaptiveAvgPooling2DLayerNodeComponent = ({
  ...
  data,
  selected,
}: AdaptiveAvgPooling2DLayerNodeProps) => {
...
export default memo(AdaptiveAvgPooling2DLayerNodeComponent);
