...
if __name__ == '__main__':
    ...
    # Train a model
    model = svm.SVC(kernel='linear')                           # TODO #2) Find a better classifier (SVC accuracy: 0.902)
    ...
    disp.plot(ax=ax, 
          cmap='viridis',  # 컬러맵을 viridis로 설정
          values_format='d',  # 정수 형태로 값 표시
          colorbar=True)  # 컬러바 표시
